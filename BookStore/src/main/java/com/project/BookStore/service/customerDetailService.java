...
public class customerDetailService {
	...
	public ResponseEntity<responseStructure<CustomerDetailDTO>> addCustomer(customer customer) {
		...
		if (repo.existsById(customer.getCustomerId()))
			throw new InvalidRequestException("Customer With Id " + customer.getCustomerId() + " Already Exists");
		if (UserCred.isEmpty())
			throw new UserNotFoundException("No User With Id " + customer.getCustomerId() + " Exists");
