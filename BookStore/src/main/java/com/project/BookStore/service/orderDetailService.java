...
public class orderDetailService {
	...
	public ResponseEntity<responseStructure<OrderDetailDTO>> viewOrderAdmin(int id) {
		...
		if(OptionalOrder.isPresent()) {
			...
			return new ResponseEntity<responseStructure<OrderDetailDTO>>(structure,HttpStatus.FOUND);
	...
	public ResponseEntity<responseStructure<List<OrderDetailDTO>>> viewAllOrdersAdmin(){
		...
		structure.setStatus_code(HttpStatus.FOUND.value());
		return new ResponseEntity<responseStructure<List<OrderDetailDTO>>>(structure,HttpStatus.FOUND);
	}
